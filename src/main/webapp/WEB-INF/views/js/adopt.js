$(function(){
 $("#btn1").click(function(){
  ...
  data:JSON.stringify({"adoptSpecies":adoptSpecies,"petSex":petSex,"adoptDes":adoptDes,"adoptRes":adoptRes,"placeInTitle":placeInTitle,"datetime":datetime,"touchName":touchName,"telNumber":telNumber}),
  dataType:"json",
